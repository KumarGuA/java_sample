...
public class compressFileInGzipFormat {
	public static void main( String[] args )
	  {
		compressFileInGzipFormat zipObj = new compressFileInGzipFormat();
	    zipObj.gzipMyFile();
	  }
	  ...
	  public void gzipMyFile(){ 
	    ...
	    try{
	      ...
	      GZIPOutputStream gos = 
	       new GZIPOutputStream(new FileOutputStream("C:\\Users\\KumarGuA\\converted.gz"));
	 
	      //Specify location of Input file here
	      FileInputStream fis = 
	       new FileInputStream("C:\\Users\\KumarGuA\\sample.txt");
